...
Manages dual-platform parallel simulations for Twitter and Reddit
...
class SimulationManager:
    ...
    Core features:
    1. Read entities from Zep graph and filter them
    ...
    def prepare_simulation(
        ...
        try:
            ...
            if filtered.filtered_count == 0:
                ...
                state.error = (
                    "No matching entities found after filtering "
                    f"(total_nodes={filtered.total_count}, defined_types={defined_entity_types or []})"
                )
                self._save_simulation_state(state)
                return state
