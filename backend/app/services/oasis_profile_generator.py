...
1. Calls Zep retrieval to enrich node information with a second pass
...
class OasisProfileGenerator:
    ...
    def _search_zep_for_entity(self, entity: EntityNode) -> Dict[str, Any]:
        ...
        need to be searched separately and then merged. Uses parallel requests
        for both searches to improve efficiency.
    ...
    def _build_entity_context(self, entity: EntityNode) -> str:
        ...
        2. Detailed information about associated nodes
    ...
    def _generate_profile_with_llm(
        ...
        # Try multiple generation attempts until success or max retries reached
        max_attempts = 3
        last_error = None
    ...
    def _get_system_prompt(self, is_individual: bool) -> str:
        """Get system prompt"""
        base_prompt = "You are a social media user profile generation expert. Generate detailed, realistic personas for public opinion simulation, maximally restoring existing real-world situations. You must return valid JSON format, and all string values must not contain unescaped newline characters. Use English."
        return base_prompt
    ...
    def _build_individual_persona_prompt(
        ...
        return f"""Generate a detailed social media user persona for this entity, maximally restoring existing real-world situations.
...
2. persona: Detailed persona description (2000 words of plain text), must include:
   ...
   - Personal memories (important part of the persona, introduce this individual's connection to events, and their existing actions and reactions in events)
...
"""
    ...
    def _build_group_persona_prompt(
        ...
        return f"""Generate a detailed social media account profile for this institution/group entity, maximally restoring existing real-world situations.
...
2. persona: Detailed account profile description (2000 words of plain text), must include:
   - Institution basic information (official name, institution type, founding background, main functions)
   ...
   - Stance and attitudes (official position on core topics, approach to handling controversies)
   - Special notes (group profile represented, operational habits)
   - Institutional memory (important part of the institution persona, introduce this institution's connection to events, and its existing actions and reactions in events)
...
- Institutional account communications must conform to its identity positioning"""
