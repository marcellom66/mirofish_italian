...
Server-side persistent project state to avoid passing large data between frontend API calls
"""
...
class Project:
    ...
    # Ontology info (populated after Interface 1 generation)
    ontology: Optional[Dict[str, Any]] = None
    analysis_summary: Optional[str] = None

    # Graph info (populated after Interface 2 completion)
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "error": self.error,
            "business_plan_metadata": self.business_plan_metadata
        }
    ...
    def from_dict(cls, data: Dict[str, Any]) -> 'Project':
        ...
        return cls(
            ...
            business_plan_metadata=data.get('business_plan_metadata')
        )
