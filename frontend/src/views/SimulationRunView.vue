<template>
  <div class="main-view">
    ...
    <header class="app-header">
      ...
      <div class="header-right">
        <div class="workflow-step">
          <span class="step-num">{{ $t('simulationRun.step') }}</span>
          <span class="step-name">{{ $t('simulationRun.startSimulation') }}</span>
        </div>
    ...
    <main class="content-area">
      ...
      <!-- Right Panel: Step3 {{ $t('simulationRun.startSimulation') }} -->
