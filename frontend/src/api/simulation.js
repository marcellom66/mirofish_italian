...
/**
 * Get simulation runtime status in real time
 * @param {string} simulationId
 */
...
/**
 * Interview all agents with a single evaluation prompt (for Quick Test)
 * @param {Object} data - { simulation_id, prompt }
 */
export const interviewAllAgents = (data) => {
  return requestWithRetry(() => service.post('/api/simulation/interview/all', data), 3, 1000)
}

/**
 * Get historical simulation list (with project details)
 * Used for displaying historical projects on the homepage
 * @param {number} limit - Limit on the number of results returned
 */
